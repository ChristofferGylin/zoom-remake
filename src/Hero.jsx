            ...
            <div className="sm:w-3/5 tracking-wide">
                <div className="flex flex-col justify-center space-y-4 mx-6 h-full font-semibold">
                    ...
                    <div className="py-2"><ButtonLink isSolid={true} link="#" title="Plans & Pricing" />
                        <a href="#" className="group text-zoom-blue">Sign Up, It´s Free <IoIosArrowForward className='text-lg fill-transparent transition ease-in-out delay-150 inline -translate-x-2 group-hover:fill-zoom-blue group-hover:translate-x-2 group-hover:inline duration-300' /></a>
                    </div>
